...
-------------------------- */
 ...
 -------------------------- */
  ...
  -------------------------- */
  {
    ...
    icon: <UserCircleIcon />,
    subItems: [
      { name: "Add Notice", path: "/notice/add", pro: false },
      { name: "Update Notice", path: "/notice/update", pro: false },
      { name: "Edit Notice", path: "/notice/edit", pro: false },
      { name: "Delete Notice", path: "/notice/delete", pro: false },
